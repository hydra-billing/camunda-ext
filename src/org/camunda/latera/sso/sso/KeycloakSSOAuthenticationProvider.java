...
public class KeycloakSSOAuthenticationProvider implements AuthenticationProvider {
    ...
    log.info("************************************");
    log.info("Begin extractAuthenticatedUser");
		...
		log.info("Got username {} from token", name);
  ...
  public void augmentResponseByAuthenticationChallenge(HttpServletResponse response, ProcessEngine engine) {
    log.info("************************************");
    log.info("inside augmentResponseByAuthenticationChallenge");
  }
